...
namespace DDDProject.MVC.Controllers
{
    public class PRODUTO_COSIFController : Controller
    {
        ...
        {
            ViewBag.COD_PRODUTO = new SelectList(db.Produtoes, "COD_PRODUTO", "DES_PRODUTO");
            return View();
        }

        // POST: PRODUTO_COSIF/Create
        ...
        public ActionResult Create([Bind(Include = "COD_PRODUTO,COD_COSIF,COD_CLASSIFICACAO,STA_STATUS")] PRODUTO_COSIF pRODUTO_COSIF)
        {
            ...
            ViewBag.COD_PRODUTO = new SelectList(db.Produtoes, "COD_PRODUTO", "DES_PRODUTO", pRODUTO_COSIF.COD_PRODUTO);
            return View(pRODUTO_COSIF);
        }
